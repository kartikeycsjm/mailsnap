  ...
  return (
    ...
    <div className='w-full h-screen bg-[#0a154b] flex justify-center items-center'>
     <div className='w-[70%] h-[50%] border rounded-xl flex justify-around items-center flex-col'> 
      <textarea className='w-[70%] h-[20%] rounded p-3 resize-none' name="" id="" cols="30" rows="10"></textarea>
      <input className='w-[70%] h-[12%] rounded p-3' type="text" placeholder='email'/>
